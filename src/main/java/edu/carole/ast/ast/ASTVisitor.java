...
public interface ASTVisitor<T> {
    ...
    T visitPassStatement(PassStatement statement);
    ...
    T visitAttributeExpression(AttributeExpression expression);
    T visitIndexExpression(IndexExpression expression);
    T visitSliceExpression(SliceExpression expression);
    ...
    T visitLambdaExpression(LambdaExpression lambdaExpression);
    ...
    T visitYieldStatement(YieldStatement expression);
