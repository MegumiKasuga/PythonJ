...
public abstract class PyMapping extends PyCollection {
    ...
    public PyObject getAttribute(Interpreter interpreter, String name) {
        switch (name) {
            ...
            case "keys":
                return new PyBuiltinFunction("keys", (args, kwargs, inter) -> {
                    if (args.size() != 0) {
            ...
            case "values":
                return new PyBuiltinFunction("values", (args, kwargs, inter) -> {
                    if (args.size() != 0) {
            ...
            case "items":
                return new PyBuiltinFunction("items", (args, kwargs, inter) -> {
                    if (args.size() != 0) {
            ...
            case "get":
                return new PyBuiltinFunction("get", (args, kwargs, inter) -> {
